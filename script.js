...
//OPEN GALLAERY images
function openimages(src) {
  document.getElementById("imagesPopup").style.display = "flex";
  document.getElementById("popupImg").src = src;
}

//CLOSE GALLERY images
...
function openReviewPopup(img, text, name) {
  ...
  document.getElementById("popupimages").src = img;
...
function vendorOpenimages(img) {
  let popup = document.getElementById("vendorimagesPopup");
...
function vendorCloseimages() {
  document.getElementById("vendorimagesPopup").style.display = "none";
}
...
//gallery page
function openGalleryimages(img) {
